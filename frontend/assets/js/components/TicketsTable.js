...
export function renderProfilesTable(trains) {
  ...
  trains.forEach((t) => {
    ...
    tr.innerHTML = `
      ...
      <td class="px-3 py-2">
        <a href="/profiles/${t.id}" data-link class="text-blue-600 hover:underline font-medium">
          ${t.train_name}
        </a>
      </td>
      ...
      <td class="px-3 py-2">
        <a href="/profiles/${t.id}" data-link
